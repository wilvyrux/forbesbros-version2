...
?>
<header
    class="header right-align-header <?php echo esc_attr( $header_class ) ?> <?php echo esc_attr( $header_dark_light ) ?>">
    <div class="<?php echo esc_attr( $header_container_cl ) ?>">
        <div class="row row-xs-center header-row">
                ...
                if ( $logo ) { ?>
                    <a id="logo" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
                        <img
                            ...
                            data-sticky="<?php echo esc_url( tm_get_logo( 'sticky' ) ) ?>"
                            data-origin="<?php echo esc_url( $logo ); ?>"/>
                    </a>
                <?php } else { ?>
            ...
            <div class="col-xs-4 col-md-9 text-right">
